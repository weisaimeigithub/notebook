<template>
    <div id="search">
        <div class="search">
            <input  type="text"  placeholder="请输入搜索联系人"  v-moddel="search"/><span><i class="fa fa-search"></i></span>
        </div>  
        ...
        <div  class="select">
            ...
            <input  type="radio" name="contacts"   @click="selectStatu=1">朋友
            <input  type="radio" name="contacts"   @click="selectStatu=1">同学
        </div>
